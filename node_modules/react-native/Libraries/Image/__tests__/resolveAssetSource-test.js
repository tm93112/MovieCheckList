  ...
  describe('bundle was loaded from network (DEV)', () => {
    beforeEach(() => {
      NativeModules.SourceCode.scriptURL =
        'http://10.0.0.1:8088/main.bundle';
      Platform.OS = 'ios';
    });
    ...
    it('uses network image', () => {
      expectResolvesAsset({
        ...
        width: 100,
        height: 200,
        uri: 'http://10.0.0.1:8088/assets/module/a/logo.png?platform=ios&hash=5b6f00f',
        scale: 1,
      });
    });
    ...
    it('picks matching scale', () => {
      expectResolvesAsset({
        ...
        width: 100,
        height: 200,
        uri: 'http://10.0.0.1:8088/assets/module/a/logo@2x.png?platform=ios&hash=5b6f00f',
        scale: 2,
      });
    });
